  ...
  Mainnet: [
    {
      ...
      symbol: "weETH",
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(BigInt(100)),
        REWARDS_BASE_INFO.etherfi(BigInt(200)),
      ],
    },
    {
      ...
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(BigInt(100)),
        REWARDS_BASE_INFO.renzo(BigInt(300)),
      ],
    },
    {
      ...
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(BigInt(100)),
        REWARDS_BASE_INFO.kelp(BigInt(200)),
      ],
    },
    {
      ...
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(BigInt(100)),
        REWARDS_BASE_INFO.swell(BigInt(450)),
      ],
    },
    {
      ...
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(BigInt(100)),
        REWARDS_BASE_INFO.puffer(BigInt(100)),
      ],
    },

    {
      ...
      symbol: "sUSDe",
      rewards: [REWARDS_BASE_INFO.ethena(BigInt(500))],
      debtRewards: [
    ...
    },
    {
      ...
      symbol: "USDe",
      rewards: [REWARDS_BASE_INFO.ethena(BigInt(2000))],
      debtRewards: [
        REWARDS_BASE_INFO.ethena(
          BigInt(500),
          "0x58c8e983d9479b69b64970f79e8965ea347189c9",
...

    {
      ...
      rewards: [
        REWARDS_BASE_INFO.renzo(BigInt(300)),
        REWARDS_BASE_INFO.symbiotic(BigInt(100)),
        REWARDS_BASE_INFO.mellow(BigInt(200)),
      ],
    },
    {
...

    {
      ...
      symbol: "LBTC",
      rewards: [
        REWARDS_BASE_INFO.babylon(BigInt(100)),
        REWARDS_BASE_INFO.lombard(BigInt(300)),
      ],
    },
    {
...

    {
      ...
      rewards: [
        ...
        REWARDS_BASE_INFO.symbiotic(BigInt(100)),
        REWARDS_BASE_INFO.etherfi(BigInt(200)),
        REWARDS_BASE_INFO.lombard(BigInt(400)),
        REWARDS_BASE_INFO.veda(BigInt(300)),
        REWARDS_BASE_INFO.karak(BigInt(200)),
      ],
    },

    {
      ...
      rewards: [
        REWARDS_BASE_INFO.babylon(BigInt(100)),
        REWARDS_BASE_INFO.pumpBTC(BigInt(200)),
      ],
    },
  ],
  Arbitrum: [
    ...
    },
    {
      ...
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(BigInt(100)),
        REWARDS_BASE_INFO.kelp(BigInt(300)),
      ],
    },
  ],
  Optimism: [
