  ...
  Mainnet: [
    {
      ...
      symbol: "weETH",
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(100),
        REWARDS_BASE_INFO.etherfi(200),
      ],
    },
    {
      ...
      rewards: [
        REWARDS_BASE_INFO.eigenlayer(100),
        REWARDS_BASE_INFO.renzo(300),
      ],
    },
    {
      address: "0xA1290d69c65A6Fe4DF752f95823fae25cB99e5A7",
      symbol: "rsETH",
      rewards: [REWARDS_BASE_INFO.eigenlayer(100), REWARDS_BASE_INFO.kelp(200)],
    },
    {
...

    {
      ...
      symbol: "sUSDe",
      rewards: [REWARDS_BASE_INFO.ethena(500)],
      debtRewards: [
    ...
    },
    {
      ...
      symbol: "USDe",
      rewards: [REWARDS_BASE_INFO.ethena(2000)],
      debtRewards: [
        REWARDS_BASE_INFO.ethena(
          500,
          "0x58c8e983d9479b69b64970f79e8965ea347189c9",
...

    {
      ...
      rewards: [
        REWARDS_BASE_INFO.renzo(300),
        REWARDS_BASE_INFO.symbiotic(100),
        REWARDS_BASE_INFO.mellow(200),
      ],
    },
    {
...

    {
      ...
      symbol: "LBTC",
      rewards: [REWARDS_BASE_INFO.babylon(100), REWARDS_BASE_INFO.lombard(300)],
    },
    {
...

    {
      ...
      symbol: "eBTC",
      rewards: [
        REWARDS_BASE_INFO.babylon(100),
        REWARDS_BASE_INFO.symbiotic(100),
        REWARDS_BASE_INFO.etherfi(200),
        REWARDS_BASE_INFO.lombard(400),
        REWARDS_BASE_INFO.veda(300),
        REWARDS_BASE_INFO.karak(200),
      ],
    },

    {
      ...
      symbol: "pumpBTC",
      rewards: [REWARDS_BASE_INFO.babylon(100), REWARDS_BASE_INFO.pumpBTC(200)],
    },
  ],
  Arbitrum: [
    {
    ...
    },
    {
      ...
      symbol: "rsETH",
      rewards: [REWARDS_BASE_INFO.eigenlayer(100), REWARDS_BASE_INFO.kelp(300)],
    },
  ],
  Optimism: [
    {
